...
namespace GameBerry
{
    public class FlowOnlyMaskImage : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private float MainSpeedX = 0.0f;

        [SerializeField]
        private float MainSpeedY = 0.0f;

        [SerializeField]
        private float MaskSpeedX = 0.0f;

        [SerializeField]
        private float MaskSpeedY = 0.0f;
        ...
        private void ApplyComponent()
        {
            ...
            myMaterial = new Material(Shader.Find("39Studio/FlowOnlyMaskImage"));
            ...
            myMaterial.SetFloat("_MaskSpeedX", MaskSpeedX);
            myMaterial.SetFloat("_MaskSpeedY", MaskSpeedY);
        }
    }
}