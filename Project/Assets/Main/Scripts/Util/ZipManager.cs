...
//        /// <param name="exclusionFiles">제외할 파일이름</param>
//        /// <returns>압축 성공 여부</returns>
//        public static bool ZipFiles(string targetFolderPath, string zipFilePath, string password, bool isDeleteFolder, string[] exclusionFiles = null)
//        {
//            bool retVal = false;
...
//                            {
//                                if (Fil.Contains(exclusionFiles[i]))
//                                {
//                                    iscontain = true;
//                                    break;
//                                }
...
//                        if (fileName.Contains("meta") || fileName.Contains("manifest"))
//                            continue;
...
//                            UnityEngine.Debug.Log("압축푼 경로 : " + unZipTargetFolderPath + theEntry.Name);
